...
def train_model(x_train, y_train, logger):
    ...
    hp = params["pm25_forecaster_t24"]["hyperparameters"]
    ...
    mlflow.set_experiment("pm25_forecaster_t24_production")
    ...
    upload_metric(
        ...
        blob_name="forecaster/pm25_model/t24_model_metrics.json",
        metric=metrics,
        logger=logger,
        artifact_name="Forecaster PM 2.5 t24 Metrics"
    )
    dump_metrics_json(metrics, "forecaster", "pm25_model", "t24_model")
    logger.info(
        "Metrics saved to metrics/forecaster/t24_model_metrics.json"
    )
