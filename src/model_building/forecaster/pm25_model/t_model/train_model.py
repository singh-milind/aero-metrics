...
def train_model(x_train, y_train, logger):
    ...
    mlflow.set_experiment("pm25_forecaster_t")
    ...
    dump_metrics_json(metrics, model_type="forecaster", model_name="t_model")
    logger.info("Metrics saved to metrics/forecaster/t_model_metrics.json")
