...
def train_model(x_train, y_train, logger):
    ...
    hp = params["pm25_forecaster_t48"]["hyperparameters"]
    ...
    mlflow.set_experiment("pm25_forecaster_t48_production")
    ...
    upload_metric(
        ...
        blob_name="forecaster/pm25_model/t48_model_metrics.json",
        metric=metrics,
        logger=logger,
