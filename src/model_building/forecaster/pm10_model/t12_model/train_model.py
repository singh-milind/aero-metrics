...
def train_model(x_train, y_train, logger):
    ...
    mlflow.set_experiment("pm10_forecaster_t12_ratio_production")
    ...
    upload_metric(
        ...
        blob_name="forecaster/pm10_model/t12_model_metrics.json",
        metric=metrics,
        logger=logger,
        artifact_name="Forecaster PM 10 t12 Metrics"
    )

    dump_metrics_json(metrics, "forecaster", "pm10_model", "t12_model")
    logger.info(
