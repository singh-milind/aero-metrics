...
def upload_model_to_blob(model,explainer,global_shap_importance,global_shap_values,X_test, logger):
    ...
    upload_model(
        ...
        blob_name="forecaster/pm10/t24_model/pm10_forecaster.pkl",
        model=model,
    ...
    upload_model(
        container_name="models",
        blob_name="forecaster/pm10/t24_model/pm10_explainer.pkl",
        model=explainer,
    ...
    upload_model(
        container_name="models",
        blob_name="forecaster/pm10/t24_model/pm10_global_shap_importance.pkl",
    ...
    upload_model(
        container_name="models",
        blob_name="forecaster/pm10/t24_model/pm10_global_shap_values.pkl",
    ...
    upload_model(
        container_name="models",
        blob_name="forecaster/pm10/t24_model/pm10_global_shap_feature_values.pkl",
        model=X_test,
        logger=logger,
...
def main():
    ...
    model_dir = ROOT_DIR / "models" / "forecaster" / "pm10" / "t24_model"
