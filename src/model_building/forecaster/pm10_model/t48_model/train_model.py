...
def train_model(x_train, y_train, logger):
    ...
    hp = params["pm10_forecaster_t48"]["hyperparameters"]
    ...
    upload_metric(
        ...
        blob_name="forecaster/pm10_model/t48_model_metrics.json",
        metric=metrics,
        logger=logger,
        artifact_name="Forecaster PM 10 t48 Metrics"
    )
    dump_metrics_json(metrics, "forecaster", "pm10_model", "t48_model")
    logger.info(
        "Metrics saved to metrics/forecaster/pm10_model/t48_model_metrics.json"
    )
