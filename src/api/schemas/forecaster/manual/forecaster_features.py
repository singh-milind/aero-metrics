...
from src.api.schemas.forecaster.manual.weather_features import add_weather_features


def compute_features(df, logger, target_time, given_data):
    try:
        ...
        df = add_weather_features(df, given_data)
